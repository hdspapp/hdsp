  ...
  "results": [
    {
      "sessionId": "7f3a9c21",
      "type": "decision",
      "title": "Drop Redis for iii state store",
  ...
  "results": [
    {
      "sessionId": "b21d004e",
      "type": "code",
      "title": "limit.ts counts per-IP",
      "narrative": "Rate limiter counts per-IP, not per-user.",
      "importance": 6
    },
    {
      "sessionId": "c98f1100",
      "type": "conversation",
      "title": "Discussed sliding window",
      "narrative": "Considered a sliding-window limiter, deferred.",
      "importance": 4
    }
  ]
}
